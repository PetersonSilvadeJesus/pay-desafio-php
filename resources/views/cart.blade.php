        ...
        <div class="container mx-auto p-6">
            ...
            <div class="mt-6 bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                ...
                <form action="{{route('payment.checkout')}}" method="post">
                    ...
                    <button type="submit" class="mt-4 w-full bg-blue-600 dark:bg-blue-400 text-white font-bold py-2 px-4 rounded-lg shadow hover:bg-blue-700 dark:hover:bg-blue-500">Finalizar Compra</button>
                </form>
            </div>
